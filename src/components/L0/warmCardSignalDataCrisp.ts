 ...
 *
 * Rules applied:
 *   - 2-line maximum per reasoning block
...
export const WARM_CARD_SIGNAL_DATA_CRISP: Record<string, WarmCardSignalEntry> = {
  ...
  'ws-india-afg': {
    ...
    reasoning:    "India vs Afghanistan at Chinnaswamy tonight — first ball at 7pm, last fixture before knockouts. I'll set your reminder and surface a fantasy XI before lock.",
  ...
  'ws-nandi-hills': {
    ...
    reasoning:    "Hebbal group rolls for the Nandi loop at 4:30am Sunday — 60km, ascent at sunrise, back by 9. I'll map your route and add you to their WhatsApp on your nod.",
  ...
  'ws-om-beach': {
    ...
    reasoning:    "Gokarna: 8 hours by road or fly-drive via Hubli — Om Beach at 6am is what you wanted in February. I'll plan it: SwaSwara overnight, sunrise yoga, Vihangama.",
  ...
  'ws-coorg': {
    ...
    reasoning:    "Attikan won the specialty cup and runs monsoon estate stays — six hours out, peak green this fortnight. I'll shortlist Ama, Attikan, and one more — two nights.",
